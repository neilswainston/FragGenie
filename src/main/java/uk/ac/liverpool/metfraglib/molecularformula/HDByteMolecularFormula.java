...
public class HDByteMolecularFormula extends ByteMolecularFormula {
	...
	protected void initialise(String molecularFormula) throws de.ipbhalle.metfraglib.exceptions.AtomTypeNotKnownFromInputListException {
		...
		java.util.ArrayList<String> elementSymbols = new java.util.ArrayList<>();
		java.util.ArrayList<Short> elementSymbolNumbers = new java.util.ArrayList<>();
	...
	public String toString() {
		...
		if(this.numberDeuterium != 0) buckets[deuteriumIndex] = this.numberDeuterium;
