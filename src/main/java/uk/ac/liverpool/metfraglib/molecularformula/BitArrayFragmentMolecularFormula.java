...
public class BitArrayFragmentMolecularFormula extends ByteMolecularFormula {
	 ...
	 */
	protected final Precursor precursorMolecule;
	/*
	 * bit array marks precursor atoms as true that are set in the fragment
	 */
	
	public BitArrayFragmentMolecularFormula(Precursor precursorMolecule) {
		this.precursorMolecule = precursorMolecule;
	}
	
	public BitArrayFragmentMolecularFormula(Precursor precursorMolecule, FastBitArray atomsFastBitArray) throws AtomTypeNotKnownFromInputListException {
