...
//	public IMolecularFormula getMolecularFormula();
	...
	/**
	 * returns 0 if given and the current structure have certain properties in
	 * common possible properties can be mass, formula etc. returns several other
	 * values dependent on the needs e.g. if comparing the mass of the structures -1
	 * can indicate that the mass of the given structure is smaller than the mass of
	 * the current one whereas a return value of 1 can indicate that the mass of the
	 * given structure is greater than the mass of the current one
	 * 
	 * @return
	 * @throws AtomTypeNotKnownFromInputListException
	 */
	 ...
	 * @throws AtomTypeNotKnownFromInputListException
	 */
	public IFragment clone(IMolecularStructure precursorMolecule) throws AtomTypeNotKnownFromInputListException;
