...
public class TopDownNeutralLossFragmenter extends TopDownFragmenter {
	...
	protected java.util.ArrayList<Short> brokenBondToNeutralLossIndex = new java.util.ArrayList<>();
	protected java.util.ArrayList<Integer> neutralLossIndex = new java.util.ArrayList<>();
	 ...
	 * @throws Exception
	 */
	public TopDownNeutralLossFragmenter(final ICandidate candidate, Settings settings) throws Exception {
		super(candidate, settings);
